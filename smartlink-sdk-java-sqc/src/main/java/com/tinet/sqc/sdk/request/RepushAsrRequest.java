...
import com.tinet.sqc.sdk.response.RepushAsrResponse;
 ...
 *
 * @author Ailos
 * @date 2021-11-29 21:31:28
 */
public class RepushAsrRequest extends BaseRequest<RepushAsrResponse> {
    ...
    public RepushAsrRequest() {
        super("/sqc/repushAsr", HttpMethodType.POST);
    }

    @Override
    public Class<RepushAsrResponse> getResponseClass() {
        return RepushAsrResponse.class;
    }
}
