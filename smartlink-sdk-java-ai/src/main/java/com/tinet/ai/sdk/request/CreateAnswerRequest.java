...
import com.tinet.ai.sdk.response.CreateAnswerResponse;
 ...
 * @date 2022/06/15
 **/
public class CreateAnswerRequest extends BaseRequest<CreateAnswerResponse> {
    ...
    public CreateAnswerRequest() {
        super("/api/botKnowledgeBase/emotibot/answer", HttpMethodType.POST);
    }
