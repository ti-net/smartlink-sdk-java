...
import com.tinet.ai.sdk.response.UpdateAnswerResponse;
 ...
 * @date 2022/06/15
 **/
public class UpdateAnswerRequest extends BaseRequest<UpdateAnswerResponse> {
    ...
    public UpdateAnswerRequest() {
        super("/api/botKnowledgeBase/emotibot/answer", HttpMethodType.PUT);
    }
